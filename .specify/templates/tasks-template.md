...
**Tests**: Automated tests are REQUIRED for each user story and bug fix unless
an approved exception is documented with fallback manual validation.
...
- [ ] T004 [P] Configure automated test execution and baseline quality checks
...
- [ ] T011 Define shared UX patterns or interface conventions for this feature
- [ ] T012 Capture performance budgets and measurement approach for key flows
...
- [ ] T013 [P] [US1] Unit test for [behavior] in tests/unit/test_[name].py
...
- [ ] T022 [US1] Verify UX states and performance budget for user story 1
...
- [ ] T023 [P] [US2] Unit test for [behavior] in tests/unit/test_[name].py
...
- [ ] T030 [US2] Verify UX states and performance budget for user story 2
...
- [ ] T031 [P] [US3] Unit test for [behavior] in tests/unit/test_[name].py
...
- [ ] T037 [US3] Verify UX states and performance budget for user story 3
...
- [ ] TXXX [P] Additional unit/integration tests to close coverage gaps
- [ ] TXXX UX consistency audit across all changed surfaces
...
- Story complete only after UX states and performance checks pass
...
- Include UX consistency and performance verification in the story where the
  user impact occurs
